...
--
-- Host: localhost:3306
-- Generation Time: Aug 14, 2025 at 01:40 PM
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `isAdmin`, `created_at`) VALUES
(1, 'admin', '$2y$10$s1BnA7n5Y23tKCFh1AM.IOV.bflGFq/mDkTXEw2uTonOi9R2kgUAW', 1, '2025-08-14 11:50:55');
...
--
ALTER TABLE `tbl_customers`
  MODIFY `customer_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

--
-- AUTO_INCREMENT for table `tbl_deceased`
--
ALTER TABLE `tbl_deceased`
  MODIFY `deceased_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `tbl_lot`
--
ALTER TABLE `tbl_lot`
  MODIFY `lot_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
